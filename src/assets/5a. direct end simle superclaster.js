...
export default {
  mounted() {
    ...
    map.on('load', function () {
      ...
      map.addLayer({   //цифры, которые накладываются на кружочки кластеров.
        id: 'cluster-count',
        type: 'symbol',
        source: 'earthquakes',
        filter: ['has', 'point_count'],
      ...
      map.on('click', 'unclustered-point', function (e) {
        ...
        //добавляем попап при клике по одиночной точке
        new mapboxgl.Popup()
